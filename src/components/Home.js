          ...
          <div className="boxGeneral">
            <div className="box">
              <img
                ...
                alt=""
              ></img>
              <NavLink className='product-span' to="/product/cvXLf92YuqNLo9JVmcy8">
                <span class="w-btn-label">Bombona Greatwhip </span>
              </NavLink>
            </div>
            <div className="box">
              <img
                ...
                alt=""
              ></img>
              <NavLink className='product-span' to="/product/fLjvKXhzYMJfnpPaPMXv">
