...
import { AddShoppingCart, FormatAlignJustify } from '@material-ui/icons';
    ...
    <Card className={classes.root}>
      ...
      <CardContent>
        <Typography variant="body2" color="textSecondary" component="p">
         Bombona de N2O, Fastgas. Las mejores bombonas utilizadas como agente mezclador y espumante al producir nata montada.
        </Typography>
      </CardContent>
