...
export const questionsShipping = [
  ...
  {
    title: "Reembolso",
    paragraph: `Creamer se hara cargo del reembolso, si el producto entregado ha llegado defectuoso.
    Seran necesarias un video comprobando que el producto ha llegado en malas condiciones, o defectuoso.
    `,
  },
  {
...
export const questionsN2O = [
  ...
  },
  {
    ...
    paragraph: `Sí. El óxido nitroso es a menudo visto como una droga recreativa, o llamado ‘gas de la risa’. 

    Recomendamos encarecidamente no inhalar el gas, ni utilizarla de manera recreativa, ya que puede llevar a sufrir alucinaciones y/o otros efectos secundarios.
